...
/// 输出: 大端序 (高字节在前)
/// </summary>
public class Crc16XmodemAlgorithm : ChecksumAlgorithmBase
{
    ...
    /// <inheritdoc/>
    public override ChecksumAlgorithmType Type => ChecksumAlgorithmType.Crc16Xmodem;

    /// <inheritdoc/>
    public override string DisplayName => "CRC-16/XMODEM";

    /// <inheritdoc/>
    public override string Description => "CRC-16 XMODEM 校验 (多项式: 0x1021, 初始值: 0x0000, 大端序)";
